        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                   Personal Training - Trends - Client Classifications
                                </li>
                            </ol>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function(){   
                $("#filteryear").on('change', function(){
                    var year=$(this).val();
                    window.location.href = 'PT-Trend-Classification.php?year='+year;
                });
            });
        </script>
            </div>
                  <div class="body">
                    <div class="col-s-12">
                         <div id="exercise" style="width: 100%; height: 400px"></div>
                    </div>
                 </div>
            </div>
            </section>
