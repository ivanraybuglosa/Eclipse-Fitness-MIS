                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            }elseif($supply['TI_Type'] == "Laundry"){
                                                echo $supply['TI_Laundry'];
                                            }else{
                                                echo $supply['TI_Delivered'];
                                            }
                                        ?>
                                    </td>
                                </tr>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center>
                                                    <button class="btn waves-effect btn-success" data-toggle="modal" data-target="#restock-<?php echo $equipment['EI_Code']; ?>" >Details</button>
                                                </center>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h3 class="modal-title"><center><?php echo $equipment['E_Type']?> - <?php echo $equipment['E_Model']?> Details</center></h3>
                                                </div>
