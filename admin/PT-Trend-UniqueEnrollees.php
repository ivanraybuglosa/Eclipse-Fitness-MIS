...
include_once("actions/PT-Trend-UniqueEnrollees-Action.php"); ?>
<section class="content">
  <div class="container-fluid">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          Personal Training - Trends - Monthly Enrollees
        </li>
      </ol>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div class="body">
      ...
      $(document).ready(function(){
        $("#filteryear").on('change', function(){
          var year=$(this).val();
          window.location.href = 'PT-Trend-UniqueEnrollees.php?year='+year;
        });
      });
      </script>
    </div>
    <div class="body">
      <div class="col-s-12">
        <div id="uniqueenrollees" style="width: 100%; height: 400px"></div>
      </div>
    </div>
  </div>
</section>
