...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = shuffleArray(["Checking Database", "Verifying Data", "Eating Tables", "Swallowing Columns", "Digesting Rows", "Compiling Data", "Importing Records", "Replacing Old Files", "Finishing Up"]);
