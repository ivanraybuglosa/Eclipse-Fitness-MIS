<?php
 ...
 include_once("actions/Client-Trend-UniqueClients-Action.php");?>
        ...
        <script>
            $(document).ready(function(){
                $("#filteryear").on('change', function(){
                    var year=$(this).val();
                    window.location.href = 'Client-Trend-UniqueClients.php?year='+year;
                });
            });
        </script>
            </div>
            <div class="body">
            <div class="col-s-12">
                 <div id="uniqueclient" style="width: 100%; height: 400px"></div>
            </div>
            </div>
        </div>
                            <footer>
