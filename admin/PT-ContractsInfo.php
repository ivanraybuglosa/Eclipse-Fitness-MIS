      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <center>
            <div class="modal-header">
              <div class="block-header">
                <h2><strong>Suggested Exercises</strong></h2>
              </div>
            </div>
            <div class="modal-body">
                  <div class="card">
            ...
            <div class="col-md-4">
              <div class="input-group">
                <div class="form-line">
                  ...
                  <input id="textbox" type="text" name="exercise" class="form-control" placeholder="Enter Session Exercise"/>
                </div>
              </div>
            </div>
            <div class="col-md-4">
