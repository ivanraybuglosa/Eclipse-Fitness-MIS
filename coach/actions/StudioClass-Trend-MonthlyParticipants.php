...
<section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Studio Class Monthly Participants</h2>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    Studio Class - Trends - Studio Class Monthly Participants
                                </li>
                            </ol>
            </div>
        </div>
    ...
    <div class="card">
            <div class="header">
                ...
                <!-- SELECT FOR YEARLY FILTER -->
                <select id="filteryear" class="validate[required] select form-control show-tick pull-right" style="margin-top: -25px; width: 30%;" data-style="btn-primary" data-live-search="true">
