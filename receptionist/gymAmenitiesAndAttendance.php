    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>Gym Amenities and Attendance</h2>
            </div>
                        ...
                        <div class="col-auto pull-left">
                           <div class="row container-fluid">
                                <div class="col-sm-12" style="margin-top: 60px;">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="Supply Towels" />
                                        </div>
                                    </div>
                                    <button type="button" class="btn bg-cyan waves-effect" style="margin-top:-20px;">
                                         <span>SUPPLY</span>
                                     </button>
                                </div>
                            </div>
                                <div class="col-sm-12" style="margin-top: 20px;">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="For laundry" />
                                        </div>
                                    </div>
                                     <button type="button" class="btn bg-red waves-effect" style="margin-top:-20px;">
                                         <span>LAUNDRY</span>
                                     </button>
                                </div>
