...
if (!isset($_SESSION['loggedIn'])) {
 ...
 include_once("actions/Amenities-Trend-TowelInAndOut-Action.php");?>
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    Amenities - Trends - Towel Monthly Reports
                                </li>
                            </ol>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function(){
                $("#filteryear").on('change', function(){
                    var year=$(this).val();
                    window.location.href = 'Amenities-Trend-TowelInAndOut.php?year='+year;
                });
            });
        </script>
            </div>
            <div class="body">
            <div class="col-s-12">
                 <div id="inandout" style="width: 100%; height: 400px"></div>
            </div>
        </div>
    </section>
